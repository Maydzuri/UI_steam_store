...
class TestAlertsJS:
    ...
    def test_js_alert_js_click(self, browser, alerts_page):
        page = alerts_page
        page.click_alert_js()
    ...
    def test_js_confirm_ok_js_click(self, browser, alerts_page):
        page = alerts_page
        page.click_confirm_js()
        alert_text = browser.accept_alert()
    ...
    def test_js_confirm_cancel_js_click(self, browser, alerts_page):
        page = alerts_page
        page.click_confirm_js()
